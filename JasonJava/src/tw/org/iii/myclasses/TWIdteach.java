...
public class TWIdteach {
	...
	public TWIdteach(boolean isMale) {
		this(isMale, (int)(Math.random()*26));
	}
	public TWIdteach(int area) {
		this((int)(Math.random()*2) == 0, area);
	}
	public TWIdteach(boolean isMale, int area) {
	...
	private TWIdteach(String id) {
		this.id = id;
	}
	
	public static TWIdteach createTWIdteach(String id) {
		TWIdteach twIdteach = null;
		if (checkId(id) ) {
			twIdteach = new TWIdteach(id);
		}
		return twIdteach;
	}
